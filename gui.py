...
def training(model_value,opened_file):
    ...
    #go to page 2
    move_to_second_page(model_value)          
...
def on_submit(sepal_length_input,sepal_length_label,sepal_width_label,sepal_width_input,petal_length_input,petal_length_label,petal_width_label,petal_width_input,classity_button,model_value):
    ...
    try:
        ...
        move_to_forth_page(model_value)
    except ValueError:
        messagebox.showerror("Error", "Please enter valid float numbers.")


def move_to_second_page(model_value):
      ...
      accuracy=Label(root, text="Accuracy :",width=40 , font=('Georgia', 16,'bold'),fg='white',bg='MediumPurple',anchor='w')
      classification_report=Label(root, text="Classification report :",width=40 , font=('Georgia', 16,'bold'),fg='white',bg='MediumPurple',anchor='w')
      confusion_matrix=Label(root, text="Confusion matrix :",width=40 , font=('Georgia', 16,'bold'),fg='white',bg='MediumPurple',anchor='w')
      instance_button=Button(root, text="Entre an instance",width=30 , font=('Georgia', 16),bg='#6A0DAD', fg='white',command=lambda:move_to_third_page(accuracy,classification_report,confusion_matrix,instance_button,model_value))


      accuracy.grid(row=0, column=0, padx=10, pady=10, sticky="e")
      classification_report.grid(row=1, column=0, padx=10, pady=10, sticky="e")
      confusion_matrix.grid(row=3, column=0, padx=10, pady=10, sticky="e")
      instance_button.grid(row=4, column=0, padx=10, pady=10)


def move_to_third_page(accuracy,classification_report,confusion_matrix,instance_button,model_value):
...
def move_to_forth_page(model_value):
     variety_label = Label(root, text="the instance is Setosa",width=40 , font=('Georgia', 16,'bold'),bg='MediumPurple',fg='white',anchor='w')
